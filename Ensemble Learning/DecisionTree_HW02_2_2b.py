...
#    print(j)
    ...
    attr_tree, branches_tree, next_branch = ID3_hw1(labels[train_data_indeces],label_size,allterms[train_data_indeces],attr_size,attr_active,MeasType,1,TreeDepth,next_branch)
